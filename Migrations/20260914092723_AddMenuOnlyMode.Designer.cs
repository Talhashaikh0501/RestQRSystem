...
namespace RestaurantQR.Migrations
{
    ...
    [Migration("20260914092723_AddMenuOnlyMode")]
    partial class AddMenuOnlyMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantQR.Models.MenuItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TDA_MenuItemOptions", (string)null);
                });
            ...
            modelBuilder.Entity("RestaurantQR.Models.SubscriptionReminderLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubscriptionId", "DaysRemaining", "ReminderType")
                        .IsUnique();

                    b.ToTable("TDA_SubscriptionReminderLogs", (string)null);
                });
            ...
            modelBuilder.Entity("RestaurantQR.Models.SubscriptionReminderLog", b =>
                {
                    b.HasOne("RestaurantQR.Models.Subscription", "Subscription")
                        .WithMany()
